...
$(function() {
	$("#btnWrite").click(function() {
		location.href="${path}/ui_page/communication/notice_write.jsp";
	});
});
//클릭한 페이지로 이동
function list(page){
...
<div id="wrap">
	...
	<div id="cont_wrap">
		<section>
			...
			<div>
				<div id="s_form">
					<form name="board_a" method="post" action="${path}/notice_servlet/search.do">
				...
				<!-- 1. 세션객체값이 관리자일때만 글 업로드가 가능하도록 설정(관리자계정 : dydals3452) -->
				<c:if test="${sessionScope.userid == 'dydals3452'}">
