...
function comment_add() {
	...
	var param="notice_num=${dto.num}&writer="+$("#writer").val()+"&content="+$("#content").val();
	$.ajax({
		type : "post",
		url : "${path}/notice_servlet/commentAdd.do",
		data : param,
		success : function(){
			$("#writer").val("");
			$("#content").val("");
				...
				<form name="form1" method="post">
					<table>
						...
						<tr>
							...
							<!-- 1. 세션객체값이 관리자일때만 글 관리를 가능하도록 설정(관리자계정 : dydals3452) -->
